...
def get_random_data(line, input_shape, random=True, max_boxes=80, hue_alter=20, sat_alter=30, val_alter=30, proc_img=True):
    ...
    image_dir = "../simulator_dataset/imgs/"
    image = cv.imread(image_dir + line[0])
    iw = image.shape[1]
    ih = image.shape[0]
    h, w = input_shape
...
if __name__ == "__main__":
    ...
    def _main():
        ...
        annotation_path = '../simulator_dataset/simulator-train.txt'
        validation_path = 'conversion_scripts/annotation-val.txt'
        log_dir = 'models/new'
        classes_path = 'models/IDD/yolo_classes.txt'
        anchors_path = 'models/IDD/yolo_anchors.txt'
